...
<section class="content">
    ...
    <div class="card">
        ...
        <div class="card-body">
        <form action="{{route('tags.update', $datatag->id)}}" method="POST" enctype="multipart/form-data" >
            @csrf
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="tags" required name="tags" value="{{$datatag->tag}}" placeholder="Masukkan Nama Tags">
                    </div>
                </div>
            </div>
        </div>
