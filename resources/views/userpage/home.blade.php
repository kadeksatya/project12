      ...
      @foreach ($datapost as $post)
            ...
            <article class="article thumb-article">
                <div class="article-img">
                    <img src="{{URL('/')}}/asset/imagepost/{{$post->gambar}}" alt="">
                </div>
                <div class="article-body">
                    <ul class="article-info">
                        @foreach ($post->label as $l)
                        <li class="article-category"><a href="#">{{$l->label}}</a></li>
                        @endforeach
                        <li class="article-type"><i class="fa fa-camera"></i></li>
                    </ul>
                    <h4 class="article-title"><a href="#">{{$post->title}}</a></h4>
                    <ul class="article-meta">
                        <li><p class="btn btn-primary btn-sm"><i class="fa fa-clock-o"></i> {{\Carbon\Carbon::parse($post->created_at)->diffForHumans()}}    </p></li>
                        <li><p class="btn btn-info btn-sm"><i class="fa fa-comments"></i> 33</p></li>
                    </ul>
                </div>
            </article>
            <!-- /ARTICLE --> 
            ...
            <div class="col-md-12">
                ...
                <div class="section-title">
                    ...
                    <ul class="tab-nav pull-right">
                        ...
                        <li><a data-toggle="tab" href="#tab2">Lifestyle</a></li>
                        <li><a data-toggle="tab" href="#tab3">News</a></li>
                        <li><a data-toggle="tab" href="#tab4">Teknologi</a></li>
                        <li><a data-toggle="tab" href="#tab5">Business</a></li>
                        <li><a data-toggle="tab" href="#tab6">Music</a></li>
                    </ul>
                    <!-- /tab nav -->
                </div>
                <!-- /section title -->
                ...
                <div class="tab-content">
                    ...
                    <div id="tab1" class="tab-pane fade in active">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6">
                                ...
                                <article class="article">
                                    ...
                                    <div class="article-body">
                                        ...
                                        @foreach ($post->label as $l)
                                        <p class="btn btn-info btn-sm">{{$l->label}}</p>
                                        @endforeach
                                        @foreach ($post->user as $u)
                                        <p class="btn btn-default btn-sm">{{$u->username}}</p>
                                        @endforeach
                            ...
                            <div class="alert alert-info text-center">Tidak ada post</div>
                ...
                <div class="widget">
                    ...
                    <div id="owl-carousel-4" class="owl-carousel owl-theme">
                        ...
                        <article class="article thumb-article">
                            ...
                            <div class="article-body">
                                <ul class="article-info">
                                    <li class="article-category"><a href="#" class="btn btn-primary">News</a></li>
                                    <li class="article-type"><i class="fa fa-video-camera"></i></li>
                                </ul>
                                <h3 class="article-title"><a href="#">Duis urbanitas eam in, tempor consequat.</a></h3>
                                <ul class="article-meta">
